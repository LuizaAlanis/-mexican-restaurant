...
namespace RestauranteMexicano.Areas.ADM.Models
{
    ...
    {
        public DefaultConnectionDB db = new DefaultConnectionDB();
        ...
        public List<Celular> SelectCelular()
        {
            ...
            while (myReader.Read())
            {
                var objCelular = new Celular()
                {
                    ...
                    proprietario = myReader["proprietario"].ToString(),
        ...
        public Celular SelectIdCelular(Celular celular)
        {
            ...
            while (myReader.Read())
            {
                ...
                objCelular.proprietario = myReader["proprietario"].ToString();
                objCelular.proprietario = myReader["observacao"].ToString();
